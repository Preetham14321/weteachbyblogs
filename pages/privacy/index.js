...
const privacy = () => {
  return (
    <>
      <div className="privacy px-8 mb-4 xl:px-20 ">
        ...
        <div className=" ">
          ...
          <span className="text-sm font-semibold">WETEACHBYBLOGS</span> and how
          we use it. <br /> <br />
          ...
          <span className="text-sm font-semibold">WETEACHBYBLOGS</span>. This
          ...
          information, including items such as name email address, and telephone
          number. <br />
          <br />
          ...
          <div className="leading-6 ml-3 ">
            ...
            marketing and promotional purposes <br /> ▪ Send you emails <br /> ▪
            Find and prevent fraud <br />
            <br />
          </div>
          <b>Log Files</b> <br />
          <br /> <span className="text-sm font-semibold">
            WETEACHBYBLOGS
          </span>{" "}
