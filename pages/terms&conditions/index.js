...
const Terms = () => {
  return (
    <>
      <div className="px-10 mb-4 xl:px-20">
        <h1 className="heading2  "> Terms & Conditions</h1>
        Welcome to <span className="text-sm font-semibold">WETEACHBYBLOGS</span>
        ! <br />
        <br />
        ...
        <span className="text-sm font-semibold">WETEACHBYBLOGS</span> if you do
        ...
        were created with the help of the Terms And Conditions Generator. <br />
        <br />
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        <span className="text-sm font-semibold">WETEACHBYBLOGS</span> does not
        ...
        <span className="text-sm font-semibold">WETEACHBYBLOGS</span>, its
        ...
        applicable laws,{" "}
        <span className="text-sm font-semibold">WETEACHBYBLOGS</span> shall not
        ...
        <br />
        <span className="text-sm font-semibold">WETEACHBYBLOGS</span> reserves
        ...
        <div className="leading-6 ml-3 ">
          ...
          necessary licenses and consents to do so; <br />▪ The Comments do not
          ...
          privacy <br />▪ The Comments will not be used to solicit or promote
          business or custom or present commercial activities or unlawful
          activity.{" "}
        </div>{" "}
        <br />
        You hereby grant{" "}
        <span className="text-sm font-semibold">WETEACHBYBLOGS</span> a
        ...
        <div className="leading-6 ml-3 ">
          ...
          and <br />▪ System wide Accredited Businesses except soliciting
        ...
        <div className="leading-6 ml-3 ">
          ...
          internet portals; <br />
          ▪ accounting, law and consulting firms; and <br />▪ educational
        ...
        <span className="text-sm font-semibold">WETEACHBYBLOGS</span>; and (d)
        ...
        e-mail to <span className="text-sm font-semibold">WETEACHBYBLOGS</span>.
